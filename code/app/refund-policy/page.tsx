        ...
        <div className="space-y-12">
          <div>
            ...
            <p className="text-muted-foreground">
              {t("legal.refundPolicy.effectiveDate")}
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              <h2 className="font-serif font-bold text-2xl text-foreground mb-4">
                {t("legal.refundPolicy.general")}
              </h2>
              <p className="text-foreground leading-relaxed">
                {t("legal.refundPolicy.generalText")}
              </p>
            </section>

            <section className="mb-8">
              <h2 className="font-serif font-bold text-2xl text-foreground mb-4">
                {t("legal.refundPolicy.special")}
              </h2>
              <p className="text-foreground leading-relaxed">
                {t("legal.refundPolicy.specialText")}
              </p>
            </section>

            <section className="mb-8">
              <h2 className="font-serif font-bold text-2xl text-foreground mb-4">
                {t("legal.refundPolicy.legal")}
              </h2>
              <p className="text-foreground leading-relaxed">
                {t("legal.refundPolicy.legalText")}
              </p>
            </section>
          </div>
        </div>
